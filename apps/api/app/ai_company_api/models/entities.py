...
class ExternalIdentity(SQLModel, table=True):
    ...
    last_confirmed_at: datetime = Field(default_factory=utc_now, index=True)
    last_status_checked_at: datetime = Field(default_factory=utc_now, index=True)
    status_check_token: str | None = Field(default=None, index=True)
